...
def accuracymeasures(y_test:pd.DataFrame, predictions:pd.DataFrame, avg_method:str) -> list:
    """This function calculates different measures for the model(s).

    Args:
        y_test (str): Path to params.yaml
